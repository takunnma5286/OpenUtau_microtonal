                        ...
                        if (singer != null) {
                            ...
                            try {
                                ...
                                if (!phrase.phones[0].direct) {
                                    vsParams.f0 = VoicevoxUtils.SampleCurve(phrase, phrase.pitches, 0, frameMs, vvTotalFrames, vsParams.phonemes[0].frame_length, vsParams.phonemes[^1].frame_length, 0, x => MusicMath.ToneToFreq(x * 0.01, phrase.Config)).ToList();
                                } else {
            ...
            try {
                ...
                if (singer != null) {
                    ...
                    var result = new RenderPitchResult {
                        tones = f0.Select(value => (float)MusicMath.FreqToTone(value, phrase.Config)).ToArray(),
