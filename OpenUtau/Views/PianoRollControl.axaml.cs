...
namespace OpenUtau.App.Views {
    ...
    public partial class PianoRollControl : UserControl, IValueTip, ICmdSubscriber {
        public MainView? MainWindow { get; set; }
        public readonly PianoRollViewModel ViewModel = null!;
        ...
        public PianoRollControl(PianoRollViewModel model) {
            InitializeComponent();
        ...
        public void KeyboardPointerPressed(object sender, PointerPressedEventArgs args) {
            ...
            System.Console.WriteLine($"[InputPerf] KeyboardPointerPressed START");
            try {
                LyricBox?.EndEdit();
                System.Console.WriteLine($"[InputPerf] LyricBox EndEdit: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
                ...
                System.Console.WriteLine($"[InputPerf] State Begin: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
            } finally {
                stopwatch.Stop();
                System.Console.WriteLine($"[InputPerf] KeyboardPointerPressed END: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
            }
        }
        ...
        public void HScrollPointerWheelChanged(object sender, PointerWheelEventArgs args) {
            ...
            try {
                ...
                if (stopwatch.Elapsed.TotalMilliseconds > 3.0) {
                    System.Console.WriteLine($"[ScrollPerf] HScroll: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
                }
            }
        }
        ...
        public void VScrollPointerWheelChanged(object sender, PointerWheelEventArgs args) {
            ...
            try {
                ...
                stopwatch.Stop();
                if (stopwatch.Elapsed.TotalMilliseconds > 3.0) {
                    System.Console.WriteLine($"[ScrollPerf] VScroll: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
                }
            }
        }
        ...
        public void TimelinePointerWheelChanged(object sender, PointerWheelEventArgs args) {
            ...
            try {
                ...
                stopwatch.Stop();
                if (stopwatch.Elapsed.TotalMilliseconds > 3.0) {
                    System.Console.WriteLine($"[ScrollPerf] TimelineScroll: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
                }
            }
        }
        ...
        public void ViewScalerPointerWheelChanged(object sender, PointerWheelEventArgs args) {
            ...
            try {
                ...
                stopwatch.Stop();
                if (stopwatch.Elapsed.TotalMilliseconds > 3.0) {
                    System.Console.WriteLine($"[ScrollPerf] ViewScalerScroll: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
                }
            }
        }
        ...
        public void NotesCanvasPointerPressed(object sender, PointerPressedEventArgs args) {
            ...
            try {
                ...
                stopwatch.Stop();
                System.Console.WriteLine($"[InputPerf] NotesCanvasPointerPressed: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
            }
        }
        ...
        private void NotesCanvasLeftPointerPressed(Control control, PointerPoint point, PointerPressedEventArgs args) {
            ...
            try {
                ...
                stopwatch.Stop();
                System.Console.WriteLine($"[InputPerf] NotesCanvasLeftPointerPressed: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
            }
        }
                ...
                if ((hitInfo.hitBody && hitInfo.note != null) || vibHitInfo.hit) {
                    ...
                    if (ViewModel.NotesViewModel.Selection.Count > 0) {
                        ...
                        ViewModel.NotesContextMenuItems.Add(new MenuItemViewModel() {
                            ...
                            Command = ReactiveCommand.Create(() => {
                                if (VisualRoot is PianoRollWindow w) {
                                    ViewModel.NotesViewModel.PasteSelectedParams(w);
                                }
                            }),
        ...
        bool OnKeyExtendedHandler(KeyEventArgs args) {
            ...
            switch (args.Key) {
                ...
                case Key.V:
                    ...
                    if (isAlt) {
                        // notesVm.PasteSelectedParams(this); // TODO: Refactor PasteSelectedParams to accept Control
                        if (VisualRoot is PianoRollWindow win) {
                            notesVm.PasteSelectedParams(win);
                        }
                        return true;
                    }
                    break;
