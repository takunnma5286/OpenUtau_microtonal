...
namespace OpenUtau.App.Controls {
    ...
    class ExpressionCanvas : Control {
        ...
        protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change) {
            ...
            // OPTIMIZATION: Only invalidate for rendering-relevant properties
            if (change.Property == TickWidthProperty ||
                ...
                change.Property == ShowRealCurveProperty) {
                InvalidateVisual();
            }
        }
        ...
        public override void Render(DrawingContext context) {
            ...
            try {
                ...
                stopwatch.Stop();
                System.Console.WriteLine($"[RenderPerf] ExpressionCanvas: {stopwatch.Elapsed.TotalMilliseconds:F3}ms");
            }
        }
